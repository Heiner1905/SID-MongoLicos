...
public class AssignmentController {
    ...
    /**
     * Asignar entrenador a usuario (solo trainers)
    ...
    /**
     * Obtener todos los usuarios asignados a un entrenador (solo trainers)
    ...
    /**
     * Desactivar asignación de un usuario (solo trainers)
